...
<html>
<head>
    <title>Laporan Insiden Telah Diterima</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Yth. Bapak/Ibu<br> 
            <strong>{{ $report->reporter_name ?? 'Pelapor' }}</strong><br>
            di<br>
            Tempat,</p>
            <p>Terima kasih telah melaporkan insiden ini. Laporan Anda dengan nomor tiket <strong>{{ $report->ticket_number }}</strong> telah kami terima.</p>
            <p>Judul Tiket:{{ $report->title }}</p>
            <p>Kami akan segera memproses laporan Anda dan memberikan update melalui email ini. Anda juga dapat melacak detail tiket Anda kapan saja melalui tautan berikut:</p>
            <p style="text-align: center;">
                {{-- Sesuaikan URL tracking dengan rute Anda --}}
                <a href="{{ url('/track-insiden/' . $report->ticket_number) }}" class="button">Lacak Tiket Anda</a>
            </p>
            <p>Terima kasih<br>
            Hormat kami,<br>
            Tim CSIRT Kementerian PKP</p>
        </div>
        <div class="footer">
