        ...
        <footer className="bg-neutral-800 text-white py-8">
            <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="flex flex-col items-center md:items-start text-center md:text-left">
                    ...
                    <p className="text-sm">
                        E-mail: <a href="mailto:kemenpkp-csirt@pkp.go.id" className="hover:underline">kemenpkp-csirt@pkp.go.id</a>
                    </p>
                </div>
                ...
                <div className="flex flex-col items-center md:items-end text-center md:text-right">
                    ...
                    <div className="flex space-x-3">
                        ...
                        <a href="https://www.instagram.com/pkp.csirt/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-white">
