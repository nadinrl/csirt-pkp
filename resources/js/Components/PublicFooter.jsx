...
export default function PublicFooter() {
    return (
        // Mengubah warna bg menjadi hitam keabuan (misal: bg-gray-900 atau bg-neutral-800)
        // Mengurangi padding vertikal (py-8 dari py-10) untuk mengecilkan footer
        <footer className="bg-neutral-800 text-white py-8">
            <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="flex flex-col items-center md:items-start text-center md:text-left">
                    ...
                    <img
                        src="/logo-pkp.png" // path harus sesuai dengan lokasi logo di folder public
                        alt="Logo Kementerian Perumahan dan Kawasan Permukiman"
                        className="h-14 mb-3" // Menyesuaikan ukuran logo lebih kecil (h-14 dari h-16, mb-3 dari mb-4)
                    />
                    <p className="text-sm font-semibold mb-1"> {/* mb-1 dari mb-2 */}
                ...
                <div className="flex flex-col items-center md:items-start text-center md:text-left">
                    <h3 className="font-bold text-base mb-3">Navigasi</h3> {/* text-base dari text-lg, mb-3 dari mb-4 */}
                    <ul className="space-y-1 text-sm"> {/* space-y-1 dari space-y-2 */}
                ...
                {/* Kolom Ketiga: Ikuti Kami (Media Sosial) */}
                <div className="flex flex-col items-center md:items-end text-center md:text-right">
                    <h3 className="font-bold text-base mb-3">Ikuti Kami</h3> {/* text-base dari text-lg, mb-3 dari mb-4 */}
                    <div className="flex space-x-3"> {/* space-x-3 dari space-x-4 */}
                        {/* Ikon Media Sosial - Menggunakan SVG placeholder. */}
            ...
            {/* Bagian footer yang lebih kecil di bagian bawah */}
            <div className="text-center text-xs mt-6"> {/* mt-6 dari mt-8, text-xs dari text-sm */}
                <p>© {new Date().getFullYear()} CSIRT Kementerian Perumahan dan Kawasan Permukiman</p>
                <p className="mt-1 text-red-400 italic">Merah Putih • Aman • Responsif</p> {/* Mengubah warna teks menjadi gray-400 agar kontras dengan background baru */}
            </div>
        </footer>
    );
}